...
namespace healthsharp7.utest.Model
{
    ...
    {
        private const string AdtA01Message = @"MSH|^~\&|SENDING_APPLICATION|SENDING_FACILITY|RECEIVING_APPLICATION|RECEIVING_FACILITY|20110613083617||ADT^A01|934576120110613083617|P|2.3||||
...
PV1|1|O|||||^^^^^^^^|^^^^^^^^";
        ...
        {
            // Arrange
            Hl7Message message = Hl7Message.Parse(AdtA01Message);
